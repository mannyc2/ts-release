...
| 3 | [005 — Generate the system contract and select the package graph and lowest-state machine](005-freeze-research-complete-system-contract.md) | P0 | XL | HIGH | Plan 003 reference manifest; PR21 `887a9fe`; Plan 004 terminal coordinate required before final freeze | IN PROGRESS — candidate-neutral schema and trials authorized; final freeze awaits Plan 004 terminal coordinate |
