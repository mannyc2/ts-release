...
export declare const restoreTree: (contentOwner: ContentOwner, tree: OwnedTree, outdir: string, provenance: Artifact.Provenance) => Effect.Effect<Artifact.HashedTree, Tree.Failure<PlatformError.PlatformError | AdoptionError, AdoptionError>, FileSystem.FileSystem | Path.Path | import("effect/Crypto").Crypto>;
