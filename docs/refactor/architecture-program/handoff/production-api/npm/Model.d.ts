...
export declare const tag: Schema.String;
export declare const repository: Schema.String;
export declare const workflow: Schema.String;
export declare const ref: Schema.String;
export declare const principal: Schema.String;
