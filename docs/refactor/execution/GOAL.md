...
Finish and close W08 with its necessary verification, independent review,
accounting, commit and saved handoff. Then stop and wait for the user's next
instruction. Do not start W09 or W10, and do not publish a release. This newer
instruction supersedes the earlier automatic continuation through publication.
At closure, report the W08 result, commit and remaining work. Pause automatic
continuation through supported task/goal controls when available; do not falsely
mark the full refactor-and-release goal complete or blocked.

The original long-term objective below remains context for future work, subject
to this explicit stopping point.

# Original goal: complete and publish the hard cut

Persistent goal: active, no token budget. It must not be marked complete or blocked
merely because the user's stopping point has been reached. The available goal
tools expose complete/blocked only, with no pause control. Honor the stopping point
above and wait after W08; the full refactor-and-publication objective remains unfinished.
...
W01–W07 are committed and pushed, ending at e5bcd6a. Earlier local results and
...
Measured product **13570=11131replacement+2439legacy**. W08 replacement tripwire9200
fails1931; exact planning variance permits further implementation without a final
waiver. Forecast13483 exceeds unchanged11485 by1998; low12723 also fails. Metadata640
...
## Work remaining after the stopping point

W09: implement approved separate OpenAI/MCP packages and reconcile the selected
agent product using advisor-plans/008b-integrate-late-providers-and-hosts.md and
handoff/waves.json. Preserve official MCP transport/auth/recovery and OpenAI
skills/marketplace/submission outcomes; execute native and packed consumer gates.
