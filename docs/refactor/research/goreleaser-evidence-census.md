...
The target column is an exact pair `kind:id`. Allowed kinds in this resolved
revision are `vnext`, `deferred`, `later`, `adjacent`, `mechanism`, and
...
| C012 | Git tag discovery and sorting | I | I | I | later:Q06-01 | Resolved later-model outcome preserved outside vNext. | [L12](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L12) |
...
| C029 | macOS universal binaries | I | I | I | later:Q07 | Resolved later-model outcome preserved outside vNext. | [L29](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L29) |
...
| C041 | MSI | I | I | I | later:P05-07 | Resolved later-model outcome preserved outside vNext. | [L41](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L41) |
...
| C046 | Docker v2 | I | I | I | later:Q03 | Resolved later-model outcome preserved outside vNext. | [L46](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L46) |
...
| C049 | Docker digests | I | I | I | later:Q03 | Resolved later-model outcome preserved outside vNext. | [L49](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L49) |
...
| C055 | Archive/package/checksum signing | I | I | I | later:P09-05 | Resolved later-model outcome preserved outside vNext. | [L55](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L55) |
| C056 | Docker manifest signing | I | I | I | later:Q03 | Resolved later-model outcome preserved outside vNext. | [L56](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L56) |
...
| C065 | Nightlies | I | I | I | later:Q05-02 | Resolved later-model outcome preserved outside vNext. | [L65](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L65) |
...
| C080 | Changelog | I | I | I | later:Q06-02 | Resolved later-model outcome preserved outside vNext. | [L80](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L80) |
...
| P004 | Smart SemVer tag sorting | I | I | I | later:Q06-01 | Resolved later-model outcome preserved outside vNext. | [L119](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L119) |
...
| P017 | MSI | I | I | I | later:P05-07 | Resolved later-model outcome preserved outside vNext. | [L132](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L132) |
...
| P023 | Advanced changelog | I | I | I | later:Q06-02 | Resolved later-model outcome preserved outside vNext. | [L138](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L138) |
...
| P026 | Changelog preview | I | I | I | later:Q06-02 | Resolved later-model outcome preserved outside vNext. | [L141](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L141) |
| P027 | Nightlies | I | I | I | later:Q05-02 | Resolved later-model outcome preserved outside vNext. | [L142](https://github.com/mannyc2/ts-release/blob/1e9efd717ff9d5dc2dbe5e079894cd8e92eb7ed3/docs/release-program/decisions/207-parity-source-cases.md#L142) |
