...
export const bool = (value: boolean): EvidenceValue => ({ _tag: "Boolean", value }); export const integer = (value: number): EvidenceValue => ({ _tag: "Integer", value }); export const text = (value: string): EvidenceValue => ({ _tag: "Text", value })
...
export const runCase = (invocation: CaseInvocation) => {
  if (invocation.fixture.caseId !== invocation.caseId) throw new Error("case and fixture differ"); const machine = new Machine(); const actions = CASE_ACTIONS[invocation.caseId]
