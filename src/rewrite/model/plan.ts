...
export class ReleaseStages extends Schema.Class<ReleaseStages>("ReleaseStages")({
  build: Schema.Array(BuildOp),
  process: Schema.Array(ProcessOp),
  catalog: Schema.Array(CatalogOp),
  validate: Schema.Array(ValidateOp),
  publish: Schema.Array(PublishOp),
  announce: Schema.Array(AnnounceOp),
  verify: Schema.Array(VerifyOp)
}) {}

export class ReleasePlanV6 extends Schema.Class<ReleasePlanV6>("ReleasePlanV6")({
  schemaVersion: Schema.Literal("release-plan/v6"),
