...
The `id` fields are project-local identifiers. Rename the build, target matrix,
entrypoint, and output template to match your CLI; ts-release uses those values
as data when it builds the release plan.
