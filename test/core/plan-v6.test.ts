...
describe("release-plan/v6 model and acceptance", () => {
  test("has seven fixed stages, sixteen closed mechanisms, and structural authority", () => {
    ...
    expect(mechanismTags).toEqual([
      ...
      "PackageRegistryRelease", "AnnouncementPublish", "SmtpPublish",
      "PackageStorePublish", "SupplyChainPublish", "ProviderPublish",
      "OpaquePublish"
    ])
    const sample = [
