...
describe("build release artifacts script", () => {
  test("derives package artifact names from scoped package identity", () => {
    ...
    expect(packageArtifactPrefix(identity)).toBe("mannyc1-ts-release-0.0.1")
    expect(packageTarballArtifactPath(identity)).toBe(".release/artifacts/mannyc1-ts-release-0.0.1.tgz")
  })

  test("defines the standalone CLI target matrix", () => {
    expect(releaseCliArtifactTargets("0.0.1")).toEqual([
      {
        id: "cli-linux-x64",
        bunTarget: "bun-linux-x64-baseline",
        outfile: ".release/artifacts/ts-release-0.0.1-linux-x64"
      },
      {
        id: "cli-linux-arm64",
        bunTarget: "bun-linux-arm64",
        outfile: ".release/artifacts/ts-release-0.0.1-linux-arm64"
      },
      {
        id: "cli-darwin-x64",
        bunTarget: "bun-darwin-x64",
        outfile: ".release/artifacts/ts-release-0.0.1-darwin-x64"
      },
      {
        id: "cli-darwin-arm64",
        bunTarget: "bun-darwin-arm64",
        outfile: ".release/artifacts/ts-release-0.0.1-darwin-arm64"
      },
      {
        id: "cli-windows-x64",
        bunTarget: "bun-windows-x64-baseline",
        outfile: ".release/artifacts/ts-release-0.0.1-windows-x64.exe"
      }
    ])
  })
